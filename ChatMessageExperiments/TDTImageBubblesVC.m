...
@implementation TDTImageBubblesVC
...
-(void) willRotateToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration
{
    ...
    for (NSIndexPath *path in [self.tableView indexPathsForVisibleRows]) {
        ...
        for(TDTImageBubbleView *obj in tempCell.contentView.subviews)
        {
...
{
    static NSString *CellIdentifier = @"imageCells";
    ...
    TDTImageBubbleView *view = [[TDTImageBubbleView alloc] initWithFrame:CGRectZero withType:data.type withSize:data.sizeOfBubble withBubbleImage:((data.type == sent)? self.bubbleImageSent:self.bubbleImageReceived)];
                     ...
                     animations: ^{
                         ...
                         else
                         {
                             ...
                             UIAlertView *alert = [[UIAlertView alloc]
                                                   initWithTitle: @"Results (UIImage Bubbles)"
