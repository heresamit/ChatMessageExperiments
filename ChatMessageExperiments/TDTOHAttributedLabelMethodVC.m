...
//
//  TDTOHAttributedLabelMethodVC.m
...
@interface TDTOHAttributedLabelMethodVC ()
...
@implementation TDTOHAttributedLabelMethodVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(!token)
    {
        labelOH = [[OHAttributedLabel alloc] init];
